...
const float BOSS_ROBOT_BB_WIDTH   = 3.0f * 300.f;	
const float BOSS_ROBOT_BB_HEIGHT  = 3.0f * 202.f;
...
Entity createProjectile(vec2 position, vec2 speed, float angle,bool ice, bool player_projectile = false, bool boss_projectile = false);
